...
class MacOSVault: NSViewController {
    ...
    func showVaultManager(vaultEnabled: Int) -> NSWindow {
        ...
        let vc = NSStoryboard(name: "Main", bundle: nil).instantiateController(withIdentifier: "MacOSVault") as! MacOSVault
...
extension MacOSVault: NSTableViewDataSource {
    func numberOfRows(in tableView: NSTableView) -> Int {
        return dataSource.count
    }
}

extension MacOSVault: NSTableViewDelegate {
